...
<CardGroup cols={2}>
  <Card
    title="Quick Start"
    icon="rocket"
    href="/docs/source-control/quickstart"
  >
    Get up and running with Relace Source Control in minutes
  </Card>
  <Card
    title="GitHub Sync"
    icon="github"
    href="/docs/source-control/github-sync"
  >
    Learn how to sync your existing GitHub repositories
  </Card>
</CardGroup>
