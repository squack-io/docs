...
## Comparison to Gemeni 2.0 Flash-Lite

Many people start doing retrieval by just passing the query/codebase pair into a model with a huge context window, like Gemeni Flash-Lite, and use a prompt to score the relevance of each file.

We beat the accuracy of Gemeni 2.0 Flash-Lite at 2x the speed and 2/3 the cost.

![Relace Reranker vs. Gemeni 2.0 Flash-Lite](/images/relace_vs_gemini_comparison.png)
