...
<Steps>
  ...
  <Step title="Parse Ranked Results from Response">
    ...
    We recommend additionally filtering out results with low relevance scores. See the [model overview](/docs/code-reranker/overview) section for more details on how to determine this threshold.
